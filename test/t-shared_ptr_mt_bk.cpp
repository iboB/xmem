...
#include <xmem/basic_atomic_shared_ptr_storage.hpp>
...
struct bookkeeping_control_block : protected control_block_base<atomic_ref_count> {
    using super = control_block_base<atomic_ref_count>;
...
template <typename T>
using atomic_shared_ptr_storage = basic_atomic_shared_ptr_storage<bookkeeping_control_block_factory, T>;
